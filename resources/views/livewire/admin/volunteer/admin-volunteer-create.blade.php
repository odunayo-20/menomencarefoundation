                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form wire:submit.prevent='store'>
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="date" wire:model='date_of_birth' name=""
                                    ...
                                    <div class="col-md-6">
                                        <label for="" class="form-label text-white">Position Applying
                                            For:</label>
                                        <div class="btn-group" role="group">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <label for="message" class="text-white">Please tell us why do you want to volunteer with
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <label for="message" class="text-white">Where did you hear about our volunteer
                                                Program?</label>
                                    ...
                                    <div class="col-md-12">
                                        <div>
                                            <label for="activities" class="text-white">Mention your previous Volunteering activities
