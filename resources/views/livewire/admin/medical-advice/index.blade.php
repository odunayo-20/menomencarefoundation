            ...
            <div class="col-12">
                <div class="bg-secondary rounded h-100 p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h6 class="mb-0">Medical Advice</h6>
                        <a href="{{ route('admin_medical_create') }}" class="btn btn-primary">
                            <i class="fa fa-plus me-2"></i>Add New Medical Advice
                        </a>
                    </div>
                            ...
                            <tbody class="text-white">
                                @forelse($advices as $advice)
                                    <tr>
                                        ...
                                        <td>
                                            <button wire:click="toggleStatus({{ $advice->id }})"
                                                class="btn btn-sm {{ $advice->status ? 'btn-success' : 'btn-secondary' }}">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('admin_medical_edit', $advice->id) }}"
                                                    class="btn btn-sm btn-outline-primary">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="#" wire:click='delete({{ $advice->id }})'
